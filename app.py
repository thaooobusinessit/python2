...
with st.sidebar:
    ...
    st.text("This interactive web application provides a \ncomprehensive analysis of senior students' mathematics \nperformance at the end of their final semester \nin a fictional high school. \nBy leveraging this \ntool, users can delve into the factors influencing \nstudents' math scores, such as gender, part-time \njob engagement, absence days, and weekly self-study hours.\nThis detailed examination allows educators, parents, and policymakers \nto identify patterns and potential areas for intervention, ultimately aiming to enhance students' academic outcomes.\nThe dataset offers a rich source of information, capturing \ndiverse aspects of students' academic lives, which can be \npivotal for informed decision-making and educational strategies.")
